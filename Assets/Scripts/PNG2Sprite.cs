...
public class PNG2Sprite : MonoBehaviour
{
    ...
    private static PNG2Sprite _instance;

    public static PNG2Sprite instance
    {
        get
        {
            ...
            if (_instance == null)
                _instance = GameObject.FindObjectOfType<PNG2Sprite>();
            return _instance;
        }
    }
